    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "GUILD_SCHEDULED_EVENT_USER_ADD": {
                 ...
                 */
                this.emit("guildScheduledEventUserAdd", packet.d.user_id, packet.d.guild_id, packet.d.guild_scheduled_event_id);
                break;
            }
            case "GUILD_SCHEDULED_EVENT_USER_REMOVE": {
                 ...
                 * @prop {String} eventID The ID of the event
                 */
                this.emit("guildScheduledEventUserRemove", packet.d.user_id, packet.d.guild_id, packet.d.guild_scheduled_event_id);
                break;
            }
