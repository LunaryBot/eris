...
module.exports.ChannelTypes = {
    ...
    GUILD_DIRECTORY:      14,
    GUILD_FORUM:          15 // Isn't released yet
};
...
Intents.allNonPrivileged = Intents.guilds
    ...
    | Intents.automodConfiguration
    | Intents.automodExecution;
...
module.exports.GuildScheduledEventsStatus = {
    SCHEDULED: 1,
    ACTIVE:    2,
    COMPLETED: 3,
    CANCELED:  4
...
module.exports.GuildScheduledEventsEntityType = {
    STAGE_INSTANCE: 1,
    VOICE:          2,
    EXTERNAL:       3
};

module.exports.AutomodTriggerTypes = {
    KEYWORD:        1,
    HARMFUL_LINK:   2,
    SPAM:           3,
    KEYWORD_PRESET: 4
...
module.exports.AutomodPresetTypes = {
    PROFANITY:      1,
    SEXUAL_CONTENT: 2,
    SLURS:          3
};

module.exports.AutomodEventTypes = {
    MESSAGE_SEND:   1
};

module.exports.AutomodActionTypes = {
    BLOCK_MESSAGE:      1,
