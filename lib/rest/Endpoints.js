...
module.exports.GUILD_SCHEDULED_EVENT =                        (guildID, eventID) => eventID ? `/guilds/${guildID}/scheduled-events/${eventID}` : `/guilds/${guildID}/scheduled-events`;
module.exports.GUILD_AUTOMOD_RULES =                          (guildID, ruleID) => ruleID ? `/guilds/${guildID}/auto-moderation/rules/${ruleID}` : `/guilds/${guildID}/auto-moderation/rules`;
...
module.exports.GUILD_SCHEDULED_EVENT_IMAGE =               (eventID, eventImage) => `guild-events/${eventID}/${eventImage}.png`;
