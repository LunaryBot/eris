...
class Message extends Base {
    ...
    /**
     * Send a message as an inline reply
     * @returns {Promise<Message>}
     */
    reply(content, file) {
        const payload = Object.assign(
            Object.create(typeof content === "string" ? {content} : content),
            {
                messageReference: {
                    messageID: this.id,
        ...
        return this._client.createMessage.call(this._client, this.channel.id, payload, file);
    }
