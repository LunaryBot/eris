...
class Guild extends Base {
    constructor(data, client) {
        ...
        this.scheduledEvents = new Collection(GuildScheduledEvent);
        this.automodRules = new Collection(AutomodRule);
        ...
        if(data.guild_scheduled_events) {
            for(const event of data.guild_scheduled_events) {
                event.guild_id = this.id;
                this.scheduledEvents.add(event, client);
            }
        }
