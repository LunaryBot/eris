...
* @prop {String} locale Selected language of the invoking user
* @prop {String?} guildLocale Guild's preferred locale, if invoked in a guild
...
* @prop {Permission} appPermissions Bitwise set of permissions the app or bot has within the channel the interaction was sent from
*/
class Interaction extends Base {
    constructor(data, client) {
        ...
        this.appPermissions = new Permission(BigInt(data.app_permissions ?? "0"));
    }
    update() {
...
const UnknownInteraction      = require("./UnknownInteraction");const Permission = require("./Permission");
