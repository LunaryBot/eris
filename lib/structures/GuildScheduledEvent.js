 ...
 * @prop {Object} guild The guild which the scheduled event belongs to
 * @prop {String?} channelID The channel id in which the scheduled event will be hosted, or null if scheduled entity type is EXTERNAL
